...
class ReadingAgent:
    def __init__(self, model):
        self.model = model
        self.system_prompt = """You are a helpful assistant that can answer questions about reading. Follow these steps when responding:

1. First, understand the user's reading question or request
2. Break down the reading concept into clear, sequential steps
